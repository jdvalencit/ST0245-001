...
public class VehiculosCompartidos
{
    ...
    public static void main(String[] args){
        ...
        guardarArchivo(permutacionParaCadaSubconjunto, 205, p);

        for(int i = 0; i < permutacionParaCadaSubconjunto.size(); i++){

            System.out.println(permutacionParaCadaSubconjunto.get(i));
        }
    }
}
